...
export default ({
  ...
  description = "Some Sweet Words from Our Satisfied Customers",
  textOnLeft = false,
  testimonials = [
    {
      stars: 5,
      ...
      quote: "Immersive and Intuitive! The user interface of NextGen Banking System is nothing short of amazing. Navigating through the seamless design feels like a breeze, making every interaction a delight. It's a testament to innovation and user-centricity. Bravo!" ,
